...
public class RestMojoAdapter extends AbstractMojo {
    ...
    /**
     * Path where API model is generated by default. Path respects Maven conventions.
     */
    ...
    /**
     * Directory or file where generated API model will be placed.
     * If value ends with ".json" it is considered, specified path represents a file. In other cases it is considered, specified path represents directory, where API model will be placed with default file name "jrapidoc.rest.model.json".
     */
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        try {
            ...
            restIntrospector.run(urls, groups, typeProviderClass, new File(modelTarget), modelHandlers, custom);
