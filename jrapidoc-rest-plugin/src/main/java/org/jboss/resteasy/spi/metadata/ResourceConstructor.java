    ...
    public ResourceConstructor(ResourceClass resourceClass, Constructor constructor) {
        ...
        if (constructor.getParameterTypes() != null) {
            ...
            for (int i = 0; i < constructor.getParameterTypes().length; i++) {
                ...
                this.params[i] = new ConstructorParameter(this, constructor.getParameterTypes()[i], constructor.getGenericParameterTypes()[i],
                        constructor.getParameterAnnotations()[i], desc, isReq);
            }
        }
    }
