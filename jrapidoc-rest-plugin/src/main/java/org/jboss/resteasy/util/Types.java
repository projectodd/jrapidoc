...
public class Types {
    ...
    /**
     * Search for the given interface or class within the root's class/interface
     * hierarchy. If the searched for class/interface is a generic return an
     * array of real types that fill it out.
     * 
     * @param root
     * @param searchedFor
     * @return
