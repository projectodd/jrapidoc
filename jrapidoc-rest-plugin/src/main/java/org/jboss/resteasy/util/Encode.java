...
public class Encode {
    ...
    /**
     * Keep encoded values "%...", matrix parameters, template parameters, and
     * '/' characters intact.
     */
    ...
    /**
     * Keep encoded values "%...", matrix parameters and template parameters
     * intact.
     */
